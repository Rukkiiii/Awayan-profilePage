    ...
    <ScrollView contentContainerStyle={styles.container(isDarkMode)}>
      <View style={styles.profileContainer}>
        <Image
          ...
          source={require('./assets/violet1.png')} 
        />
        <Text style={styles.profileName(isDarkMode)}>Roque Awayan</Text>
        <Text style={styles.profileEmail(isDarkMode)}>I'm the honored one</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  iconContainer: (isDarkMode) => ({
    ...
    justifyContent: 'center',
    alignItems: 'center',
    // Removed the border since we are using background colors
  }),
